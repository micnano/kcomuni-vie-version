...
/**
 * The ezfSolrDocumentTnsolFieldObjectRelation class handles indexing and
 * querying for the ezobjectrelation and ezobjectrelationlist in eZFind.
 * It works fine with space in multiword facets and filters
 * 
 * @package TnSol
 */
class ezfSolrDocumentKcomuniFieldObjectRelation extends ezfSolrDocumentFieldBase
{
    /**
